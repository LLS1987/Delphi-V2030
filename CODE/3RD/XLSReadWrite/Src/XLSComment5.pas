...
protected
     ...
     FHeadingFont : TXLSCommentFont;
     FFont        : TXLSCommentFont;
...
public
     ...
     procedure Font(const AName: AxUCString; ASize: integer; ABold, AItalic: boolean);
     procedure HeadingFont(const AName: AxUCString; ASize: integer; ABold, AItalic: boolean);

     procedure ClearFont;
     procedure ClearHeadingFont;
...
begin
  ...
  if FAuthor <> '' then begin
    ...
    FR.Index := 0;
    if FHeadingFont <> Nil then
      FR.Font := FStyleSheet.Fonts.MakeCommentFont(FHeadingFont.Name,FHeadingFont.Size,FHeadingFont.Bold,FHeadingFont.Italic)
    else
  ...
  FR.Index := i;
  if FFont <> Nil then
    FR.Font := FStyleSheet.Fonts.MakeCommentFont(FFont.Name,FFont.Size,FFont.Bold,FFont.Italic)
  else
...
procedure TXLSComments.ClearFont;
begin
...
procedure TXLSComments.ClearHeadingFont;
begin
  if FHeadingFont <> Nil then begin
    FHeadingFont.Free;
    FHeadingFont := Nil;
  end;
end;
...
procedure TXLSComments.Font(const AName: AxUCString; ASize: integer; ABold, AItalic: boolean);
begin
  if FFont = Nil then
    FFont := TXLSCommentFont.Create;

  FFont.Name := AName;
  FFont.Size := ASize;
  FFont.Bold := ABold;
  FFont.Italic := AItalic;
end;
...
procedure TXLSComments.HeadingFont(const AName: AxUCString; ASize: integer; ABold, AItalic: boolean);
begin
  if FHeadingFont = Nil then
    FHeadingFont := TXLSCommentFont.Create;

  FHeadingFont.Name := AName;
  FHeadingFont.Size := ASize;
  FHeadingFont.Bold := ABold;
  FHeadingFont.Italic := AItalic;
end;
