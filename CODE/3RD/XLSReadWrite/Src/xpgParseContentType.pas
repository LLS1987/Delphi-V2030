...
{$ifdef DELPHI_5}
var FEnums_2: TStringList;
{$else}
var FEnums_2: THashedStringList;
{$endif}
...
var
  i: integer;
begin
  i := FEnums_2.IndexOf(AValue);
  if i >= 0 then
    Result := Integer(FEnums_2.Objects[i])
  else
    Result := 0;
end;
...
{$else}
  FEnums_2 := THashedStringList.Create;
{$endif}
  TXPGBase.AddEnums;
