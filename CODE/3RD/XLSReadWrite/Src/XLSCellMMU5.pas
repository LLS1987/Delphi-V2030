...
begin
  ...
  FDefaultRowHdr.SpanC1 := $FFFF;
  FDefaultRowHdr.SpanC2 := $FFFF;
...
{$ifdef AXAST}
        i64 := Round(Frac(Abs(V)) * 10000);
        v64 := Round(V * 10000);
//        i64 := Round(V * 10000);

//        n := i64 - ((i64 div 10) * 10);
//        n := i64 - ((i64 div 100) * 100);
//        n := i64 - ((i64 div 1000) * 1000);
//        n := i64 - ((i64 div 10000) * 10000);
//
//
        if (i64 - ((i64 div 10) * 10)) <> 0 then
          n := 4
        else if (i64 - ((i64 div 100) * 100)) <> 0 then
          n := 3
        else if (i64 - ((i64 div 1000) * 1000)) <> 0 then
          n := 2
        else if (i64 - ((i64 div 10000) * 10000)) <> 0 then
          n := 1
        else
          n := 0;

        if n = 0 then begin
          PInteger(@AResult)^ := v64 div 10000;
          Result := CELLXL_NUM_32;
        end
        else if ((n = 1) or (n = 2)) and ((i64 * 100) <= MAXINT) and ((i64 * 100) >= XLS_MININT) then begin
          PInteger(@AResult)^ := v64 div 100;
          Result := CELLXL_NUM_2DEC;
        end
        else if ((n = 3) or (n = 4)) and ((i64 * 100) <= MAXINT) and ((i64 * 100) >= XLS_MININT) then begin
          PInteger(@AResult)^ := v64;
...
begin
  case AXLate and XVECT_XLATE_MASK of
    ...
    else raise XLSRWException.Create('Invalid XLate value; ');
  end;
  if (AXLate and CELLXL_FLAG_STYLE) <> 0 then
