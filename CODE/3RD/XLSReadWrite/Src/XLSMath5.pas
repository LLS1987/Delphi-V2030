...
protected
public
     function Iterate: double; overload; virtual;
     function Iterate(x: double): double; overload; virtual;
     end;

type TIterateFuncTriple = class(TObject)
protected
public
     function Iterate(AValue: double): TFloatTriple; virtual;
     end;

type TIterateFuncPair = class(TObject)
protected
public
     function Iterate: TFloatPair; overload; virtual;
     function Iterate(x: double): TFloatPair; overload; virtual;
     end;
...
begin
   ...
   factor := ldexp(1.0, 1 - digits);
   delta := Max(10000000.0 * guess, 10000000.0);
   last_f0 := 0;
   delta1 := delta;
//   delta2 := delta; unused
...
function TIterateFuncPair.Iterate(x: double): TFloatPair;
begin
  Result.a := 0.0;
  Result.b := 0.0;
end;

function TIterateFuncPair.Iterate: TFloatPair;
begin
  Result.a := 0.0;
  Result.b := 0.0;
end;
...
function TIterateFunc.Iterate(x: double): double;
begin
  Result := 0.0;
end;

function TIterateFunc.Iterate: double;
begin
  Result := 0.0;
end;
...
function TIterateFuncTriple.Iterate(AValue: double): TFloatTriple;
begin
  Result.a := 0.0;
  Result.b := 0.0;
  Result.c := 0.0;
