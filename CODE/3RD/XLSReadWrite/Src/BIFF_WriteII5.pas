...
begin
  ...
  try
    ...
    for i := 0 to FXLS.Sheets.Count - 1 do begin
      ...
      if FCurrXc12Sheet.SheetViews.Count < 1 then
        FCurrXc12Sheet.SheetViews.Add;
...
//              FExternalNamesWritten := True;
          ...
          BIFFRECID_TABID: begin
            if FXLS.Records[i].Length = 0 then begin
              ...
              if FXLS.PreserveMacros and (FXLS.VBA <> Nil) then
                WREC_OBPROJ;
            end;
          end;
...
begin
  if FXLS.PreserveMacros and not FVBAWritten then begin
...
begin
  ...
  if FXLS.Version > xvExcel40 then begin
    ...
    // Don't know the cause of this bug.
    if FCurrXc12Sheet.SheetViews[0] = Nil then begin
      FCurrXc12Sheet.SheetViews.Clear;
      FCurrXc12Sheet.SheetViews.Add;
    end;
