...
function TXLSStream.ReadUnencrypted(var Buffer; Count: longint): longint;
var
  TempEnc: boolean;
begin
...
function TXLSStream.ReadUnencryptedSync(var Buffer; Count: longint): longint;
var
...
function TXLSStream.IntWrite(const Buffer; Count: longint): longint;
begin
  if FStream = Nil then
...
procedure TXLSStream.WriteCONTINUE(RecId: word; const Buffer; Count: longint);
var
  P: PByteArray;
  L,L2: integer;
begin
