...
public
     ...
     function  ReadXLSM(Storage: IStorage): TVBAReadResult;
     //* ~exclude
...
function TXLSVBA.ReadXLSM(Storage: IStorage): TVBAReadResult;
var
  Sz: integer;
  stgRoot,stgVBA: IStorage;
  Stream: IStream;
...
begin
  Result := vbarrFailure;
  OleCheck(Storage.OpenStorage(VBA_SUBDIR_NAME,Nil,STGM_READ or STGM_SHARE_EXCLUSIVE,Nil,0,stgVBA));
