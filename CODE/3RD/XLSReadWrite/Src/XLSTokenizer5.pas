...
const Xc12Chr_ErrorChar = AnsiChar('#');
const Xc12Chr_FullStop = AnsiChar('.');
const Xc12Chr_Hash = AnsiChar('#');
const Xc12Chr_Quote = AnsiChar('"');
const Xc12Chr_Aphostrophe = AnsiChar('''');
const Xc12Chr_Comma = AnsiChar(',');
const Xc12Chr_Colon = AnsiChar(':');
const Xc12Chr_Semicolon = AnsiChar(';');
const Xc12Chr_Space = AnsiChar(' ');
const Xc12Chr_BeginArray = AnsiChar('{');
const Xc12Chr_EndArray = AnsiChar('}');
const Xc12Chr_LPar = AnsiChar('(');
const Xc12Chr_RPar = AnsiChar(')');
const Xc12Chr_Underscore = AnsiChar('_');
const Xc12Chr_Backslash = AnsiChar('\');
...
begin
  ...
  if CurrChar = Xc12Chr_ErrorChar then begin
    P.P1 := FIndex;
    for e := errNull to High(TXc12CellError) do begin
