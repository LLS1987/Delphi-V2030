...
{$ifdef DELPHI_5}
var FEnums_3: TStringList;
{$else}
var FEnums_3: THashedStringList;
{$endif}
...
begin
  FEnums_3.AddObject('stabtVariant',TObject(0));
  FEnums_3.AddObject('stabtI1',TObject(1));
  FEnums_3.AddObject('stabtI2',TObject(2));
  FEnums_3.AddObject('stabtI4',TObject(3));
  FEnums_3.AddObject('stabtInt',TObject(4));
  FEnums_3.AddObject('stabtUi1',TObject(5));
  FEnums_3.AddObject('stabtUi2',TObject(6));
  FEnums_3.AddObject('stabtUi4',TObject(7));
  FEnums_3.AddObject('stabtUint',TObject(8));
  FEnums_3.AddObject('stabtR4',TObject(9));
  FEnums_3.AddObject('stabtR8',TObject(10));
  FEnums_3.AddObject('stabtDecimal',TObject(11));
  FEnums_3.AddObject('stabtBstr',TObject(12));
  FEnums_3.AddObject('stabtDate',TObject(13));
  FEnums_3.AddObject('stabtBool',TObject(14));
  FEnums_3.AddObject('stabtCy',TObject(15));
  FEnums_3.AddObject('stabtError',TObject(16));
  FEnums_3.AddObject('stvbtVariant',TObject(0));
  FEnums_3.AddObject('stvbtI1',TObject(1));
  FEnums_3.AddObject('stvbtI2',TObject(2));
  FEnums_3.AddObject('stvbtI4',TObject(3));
  FEnums_3.AddObject('stvbtI8',TObject(4));
  FEnums_3.AddObject('stvbtUi1',TObject(5));
  FEnums_3.AddObject('stvbtUi2',TObject(6));
  FEnums_3.AddObject('stvbtUi4',TObject(7));
  FEnums_3.AddObject('stvbtUi8',TObject(8));
  FEnums_3.AddObject('stvbtR4',TObject(9));
  FEnums_3.AddObject('stvbtR8',TObject(10));
  FEnums_3.AddObject('stvbtLpstr',TObject(11));
  FEnums_3.AddObject('stvbtLpwstr',TObject(12));
  FEnums_3.AddObject('stvbtBstr',TObject(13));
  FEnums_3.AddObject('stvbtDate',TObject(14));
  FEnums_3.AddObject('stvbtFiletime',TObject(15));
  FEnums_3.AddObject('stvbtBool',TObject(16));
  FEnums_3.AddObject('stvbtCy',TObject(17));
  FEnums_3.AddObject('stvbtError',TObject(18));
  FEnums_3.AddObject('stvbtClsid',TObject(19));
  FEnums_3.AddObject('stvbtCf',TObject(20));
end;
...
var
  i: integer;
begin
  i := FEnums_3.IndexOf(AValue);
  if i >= 0 then 
    Result := Integer(FEnums_3.Objects[i])
  else 
    Result := 0;
end;
...
var
  R: TCT_VariantXpgList;
begin
  R := TCT_VariantXpgList.Create(FOwner);
...
{$else}
  FEnums_3 := THashedStringList.Create;
{$endif}
  TXPGBase.AddEnums;
