...
public
     property Errors: TXpgPErrors read FErrors write FErrors;
...
protected
     ...
     procedure AfterTag(AReader: TXPGReader); virtual;
...
protected
     ...
     procedure WriteAttributes(AWriter: TXpgWriteXML);
     procedure AssignAttributes(AAttributes: TXpgXMLAttributeList); override;
     procedure AfterTag(AReader: TXPGReader); override;
public
     constructor Create(AOwner: TXPGDocBase);
     destructor Destroy; override;
     procedure Clear;
     ...
     property ExtLst: TCT_ExtensionList read FExtLst;
     property TableMode: boolean read FTableMode write FTableMode;
     end;
...
{$ifdef DELPHI_5}
var FEnums_5: TStringList;
{$else}
var FEnums_5: THashedStringList;
{$endif}
...
procedure TXPGBase.AfterTag(AReader: TXPGReader);
begin
end;

class procedure TXPGBase.AddEnums;
begin
  FEnums_5.AddObject('stuvSingle',TObject(0));
  FEnums_5.AddObject('stuvDouble',TObject(1));
  FEnums_5.AddObject('stuvSingleAccounting',TObject(2));
  FEnums_5.AddObject('stuvDoubleAccounting',TObject(3));
  FEnums_5.AddObject('stuvNone',TObject(4));
  FEnums_5.AddObject('stvarBaseline',TObject(0));
  FEnums_5.AddObject('stvarSuperscript',TObject(1));
  FEnums_5.AddObject('stvarSubscript',TObject(2));
  FEnums_5.AddObject('stvaTop',TObject(0));
  FEnums_5.AddObject('stvaCenter',TObject(1));
  FEnums_5.AddObject('stvaBottom',TObject(2));
  FEnums_5.AddObject('stvaJustify',TObject(3));
  FEnums_5.AddObject('stvaDistributed',TObject(4));
  FEnums_5.AddObject('stbsNone',TObject(0));
  FEnums_5.AddObject('stbsThin',TObject(1));
  FEnums_5.AddObject('stbsMedium',TObject(2));
  FEnums_5.AddObject('stbsDashed',TObject(3));
  FEnums_5.AddObject('stbsDotted',TObject(4));
  FEnums_5.AddObject('stbsThick',TObject(5));
  FEnums_5.AddObject('stbsDouble',TObject(6));
  FEnums_5.AddObject('stbsHair',TObject(7));
  FEnums_5.AddObject('stbsMediumDashed',TObject(8));
  FEnums_5.AddObject('stbsDashDot',TObject(9));
  FEnums_5.AddObject('stbsMediumDashDot',TObject(10));
  FEnums_5.AddObject('stbsDashDotDot',TObject(11));
  FEnums_5.AddObject('stbsMediumDashDotDot',TObject(12));
  FEnums_5.AddObject('stbsSlantDashDot',TObject(13));
  FEnums_5.AddObject('stptNone',TObject(0));
  FEnums_5.AddObject('stptSolid',TObject(1));
  FEnums_5.AddObject('stptMediumGray',TObject(2));
  FEnums_5.AddObject('stptDarkGray',TObject(3));
  FEnums_5.AddObject('stptLightGray',TObject(4));
  FEnums_5.AddObject('stptDarkHorizontal',TObject(5));
  FEnums_5.AddObject('stptDarkVertical',TObject(6));
  FEnums_5.AddObject('stptDarkDown',TObject(7));
  FEnums_5.AddObject('stptDarkUp',TObject(8));
  FEnums_5.AddObject('stptDarkGrid',TObject(9));
  FEnums_5.AddObject('stptDarkTrellis',TObject(10));
  FEnums_5.AddObject('stptLightHorizontal',TObject(11));
  FEnums_5.AddObject('stptLightVertical',TObject(12));
  FEnums_5.AddObject('stptLightDown',TObject(13));
  FEnums_5.AddObject('stptLightUp',TObject(14));
  FEnums_5.AddObject('stptLightGrid',TObject(15));
  FEnums_5.AddObject('stptLightTrellis',TObject(16));
  FEnums_5.AddObject('stptGray125',TObject(17));
  FEnums_5.AddObject('stptGray0625',TObject(18));
  FEnums_5.AddObject('stfsNone',TObject(0));
  FEnums_5.AddObject('stfsMajor',TObject(1));
  FEnums_5.AddObject('stfsMinor',TObject(2));
  FEnums_5.AddObject('stgtLinear',TObject(0));
  FEnums_5.AddObject('stgtPath',TObject(1));
  FEnums_5.AddObject('sttstWholeTable',TObject(0));
  FEnums_5.AddObject('sttstHeaderRow',TObject(1));
  FEnums_5.AddObject('sttstTotalRow',TObject(2));
  FEnums_5.AddObject('sttstFirstColumn',TObject(3));
  FEnums_5.AddObject('sttstLastColumn',TObject(4));
  FEnums_5.AddObject('sttstFirstRowStripe',TObject(5));
  FEnums_5.AddObject('sttstSecondRowStripe',TObject(6));
  FEnums_5.AddObject('sttstFirstColumnStripe',TObject(7));
  FEnums_5.AddObject('sttstSecondColumnStripe',TObject(8));
  FEnums_5.AddObject('sttstFirstHeaderCell',TObject(9));
  FEnums_5.AddObject('sttstLastHeaderCell',TObject(10));
  FEnums_5.AddObject('sttstFirstTotalCell',TObject(11));
  FEnums_5.AddObject('sttstLastTotalCell',TObject(12));
  FEnums_5.AddObject('sttstFirstSubtotalColumn',TObject(13));
  FEnums_5.AddObject('sttstSecondSubtotalColumn',TObject(14));
  FEnums_5.AddObject('sttstThirdSubtotalColumn',TObject(15));
  FEnums_5.AddObject('sttstFirstSubtotalRow',TObject(16));
  FEnums_5.AddObject('sttstSecondSubtotalRow',TObject(17));
  FEnums_5.AddObject('sttstThirdSubtotalRow',TObject(18));
  FEnums_5.AddObject('sttstBlankRow',TObject(19));
  FEnums_5.AddObject('sttstFirstColumnSubheading',TObject(20));
  FEnums_5.AddObject('sttstSecondColumnSubheading',TObject(21));
  FEnums_5.AddObject('sttstThirdColumnSubheading',TObject(22));
  FEnums_5.AddObject('sttstFirstRowSubheading',TObject(23));
  FEnums_5.AddObject('sttstSecondRowSubheading',TObject(24));
  FEnums_5.AddObject('sttstThirdRowSubheading',TObject(25));
  FEnums_5.AddObject('sttstPageFieldLabels',TObject(26));
  FEnums_5.AddObject('sttstPageFieldValues',TObject(27));
  FEnums_5.AddObject('sthaGeneral',TObject(0));
  FEnums_5.AddObject('sthaLeft',TObject(1));
  FEnums_5.AddObject('sthaCenter',TObject(2));
  FEnums_5.AddObject('sthaRight',TObject(3));
  FEnums_5.AddObject('sthaFill',TObject(4));
  FEnums_5.AddObject('sthaJustify',TObject(5));
  FEnums_5.AddObject('sthaCenterContinuous',TObject(6));
  FEnums_5.AddObject('sthaDistributed',TObject(7));
  FEnums_5.AddObject('stpaNoControl',TObject(0));
  FEnums_5.AddObject('stpaLeft',TObject(1));
  FEnums_5.AddObject('stpaCenter',TObject(2));
  FEnums_5.AddObject('stpaDistributed',TObject(3));
  FEnums_5.AddObject('stptHalfwidthKatakana',TObject(0));
  FEnums_5.AddObject('stptFullwidthKatakana',TObject(1));
  FEnums_5.AddObject('stptHiragana',TObject(2));
  FEnums_5.AddObject('stptNoConversion',TObject(3));
  FEnums_5.AddObject('stdtgYear',TObject(0));
  FEnums_5.AddObject('stdtgMonth',TObject(1));
  FEnums_5.AddObject('stdtgDay',TObject(2));
  FEnums_5.AddObject('stdtgHour',TObject(3));
  FEnums_5.AddObject('stdtgMinute',TObject(4));
  FEnums_5.AddObject('stdtgSecond',TObject(5));
  FEnums_5.AddObject('stsmStroke',TObject(0));
  FEnums_5.AddObject('stsmPinYin',TObject(1));
  FEnums_5.AddObject('stsmNone',TObject(2));
  FEnums_5.AddObject('stctNone',TObject(0));
  FEnums_5.AddObject('stctGregorian',TObject(1));
  FEnums_5.AddObject('stctGregorianUs',TObject(2));
  FEnums_5.AddObject('stctJapan',TObject(3));
  FEnums_5.AddObject('stctTaiwan',TObject(4));
  FEnums_5.AddObject('stctKorea',TObject(5));
  FEnums_5.AddObject('stctHijri',TObject(6));
  FEnums_5.AddObject('stctThai',TObject(7));
  FEnums_5.AddObject('stctHebrew',TObject(8));
  FEnums_5.AddObject('stctGregorianMeFrench',TObject(9));
  FEnums_5.AddObject('stctGregorianArabic',TObject(10));
  FEnums_5.AddObject('stctGregorianXlitEnglish',TObject(11));
  FEnums_5.AddObject('stctGregorianXlitFrench',TObject(12));
  FEnums_5.AddObject('stsbValue',TObject(0));
  FEnums_5.AddObject('stsbCellColor',TObject(1));
  FEnums_5.AddObject('stsbFontColor',TObject(2));
  FEnums_5.AddObject('stsbIcon',TObject(3));
  FEnums_5.AddObject('stist3Arrows',TObject(0));
  FEnums_5.AddObject('stist3ArrowsGray',TObject(1));
  FEnums_5.AddObject('stist3Flags',TObject(2));
  FEnums_5.AddObject('stist3TrafficLights1',TObject(3));
  FEnums_5.AddObject('stist3TrafficLights2',TObject(4));
  FEnums_5.AddObject('stist3Signs',TObject(5));
  FEnums_5.AddObject('stist3Symbols',TObject(6));
  FEnums_5.AddObject('stist3Symbols2',TObject(7));
  FEnums_5.AddObject('stist4Arrows',TObject(8));
  FEnums_5.AddObject('stist4ArrowsGray',TObject(9));
  FEnums_5.AddObject('stist4RedToBlack',TObject(10));
  FEnums_5.AddObject('stist4Rating',TObject(11));
  FEnums_5.AddObject('stist4TrafficLights',TObject(12));
  FEnums_5.AddObject('stist5Arrows',TObject(13));
  FEnums_5.AddObject('stist5ArrowsGray',TObject(14));
  FEnums_5.AddObject('stist5Rating',TObject(15));
  FEnums_5.AddObject('stist5Quarters',TObject(16));
  FEnums_5.AddObject('stdftNull',TObject(0));
  FEnums_5.AddObject('stdftAboveAverage',TObject(1));
  FEnums_5.AddObject('stdftBelowAverage',TObject(2));
  FEnums_5.AddObject('stdftTomorrow',TObject(3));
  FEnums_5.AddObject('stdftToday',TObject(4));
  FEnums_5.AddObject('stdftYesterday',TObject(5));
  FEnums_5.AddObject('stdftNextWeek',TObject(6));
  FEnums_5.AddObject('stdftThisWeek',TObject(7));
  FEnums_5.AddObject('stdftLastWeek',TObject(8));
  FEnums_5.AddObject('stdftNextMonth',TObject(9));
  FEnums_5.AddObject('stdftThisMonth',TObject(10));
  FEnums_5.AddObject('stdftLastMonth',TObject(11));
  FEnums_5.AddObject('stdftNextQuarter',TObject(12));
  FEnums_5.AddObject('stdftThisQuarter',TObject(13));
  FEnums_5.AddObject('stdftLastQuarter',TObject(14));
  FEnums_5.AddObject('stdftNextYear',TObject(15));
  FEnums_5.AddObject('stdftThisYear',TObject(16));
  FEnums_5.AddObject('stdftLastYear',TObject(17));
  FEnums_5.AddObject('stdftYearToDate',TObject(18));
  FEnums_5.AddObject('stdftQ1',TObject(19));
  FEnums_5.AddObject('stdftQ2',TObject(20));
  FEnums_5.AddObject('stdftQ3',TObject(21));
  FEnums_5.AddObject('stdftQ4',TObject(22));
  FEnums_5.AddObject('stdftM1',TObject(23));
  FEnums_5.AddObject('stdftM2',TObject(24));
  FEnums_5.AddObject('stdftM3',TObject(25));
  FEnums_5.AddObject('stdftM4',TObject(26));
  FEnums_5.AddObject('stdftM5',TObject(27));
  FEnums_5.AddObject('stdftM6',TObject(28));
  FEnums_5.AddObject('stdftM7',TObject(29));
  FEnums_5.AddObject('stdftM8',TObject(30));
  FEnums_5.AddObject('stdftM9',TObject(31));
  FEnums_5.AddObject('stdftM10',TObject(32));
  FEnums_5.AddObject('stdftM11',TObject(33));
  FEnums_5.AddObject('stdftM12',TObject(34));
  FEnums_5.AddObject('stfoEqual',TObject(0));
  FEnums_5.AddObject('stfoLessThan',TObject(1));
  FEnums_5.AddObject('stfoLessThanOrEqual',TObject(2));
  FEnums_5.AddObject('stfoNotEqual',TObject(3));
  FEnums_5.AddObject('stfoGreaterThanOrEqual',TObject(4));
  FEnums_5.AddObject('stfoGreaterThan',TObject(5));
  FEnums_5.AddObject('staAxisRow',TObject(0));
  FEnums_5.AddObject('staAxisCol',TObject(1));
  FEnums_5.AddObject('staAxisPage',TObject(2));
  FEnums_5.AddObject('staAxisValues',TObject(3));
  FEnums_5.AddObject('stpatNone',TObject(0));
  FEnums_5.AddObject('stpatNormal',TObject(1));
  FEnums_5.AddObject('stpatData',TObject(2));
  FEnums_5.AddObject('stpatAll',TObject(3));
  FEnums_5.AddObject('stpatOrigin',TObject(4));
  FEnums_5.AddObject('stpatButton',TObject(5));
  FEnums_5.AddObject('stpatTopRight',TObject(6));
  FEnums_5.AddObject('stvVisible',TObject(0));
  FEnums_5.AddObject('stvHidden',TObject(1));
  FEnums_5.AddObject('stvVeryHidden',TObject(2));
  FEnums_5.AddObject('stcmManual',TObject(0));
  FEnums_5.AddObject('stcmAuto',TObject(1));
  FEnums_5.AddObject('stcmAutoNoTable',TObject(2));
  FEnums_5.AddObject('stulUserSet',TObject(0));
  FEnums_5.AddObject('stulNever',TObject(1));
  FEnums_5.AddObject('stulAlways',TObject(2));
  FEnums_5.AddObject('sttss544x376',TObject(0));
  FEnums_5.AddObject('sttss640x480',TObject(1));
  FEnums_5.AddObject('sttss720x512',TObject(2));
  FEnums_5.AddObject('sttss800x600',TObject(3));
  FEnums_5.AddObject('sttss1024x768',TObject(4));
  FEnums_5.AddObject('sttss1152x882',TObject(5));
  FEnums_5.AddObject('sttss1152x900',TObject(6));
  FEnums_5.AddObject('sttss1280x1024',TObject(7));
  FEnums_5.AddObject('sttss1600x1200',TObject(8));
  FEnums_5.AddObject('sttss1800x1440',TObject(9));
  FEnums_5.AddObject('sttss1920x1200',TObject(10));
  FEnums_5.AddObject('stcCommNone',TObject(0));
  FEnums_5.AddObject('stcCommIndicator',TObject(1));
  FEnums_5.AddObject('stcCommIndAndComment',TObject(2));
  FEnums_5.AddObject('stoAll',TObject(0));
  FEnums_5.AddObject('stoPlaceholders',TObject(1));
  FEnums_5.AddObject('stoNone',TObject(2));
  FEnums_5.AddObject('ststsAll',TObject(0));
  FEnums_5.AddObject('ststsNone',TObject(1));
  FEnums_5.AddObject('ststsNoIndicator',TObject(2));
  FEnums_5.AddObject('strmA1',TObject(0));
  FEnums_5.AddObject('strmR1C1',TObject(1));
  FEnums_5.AddObject('stssVisible',TObject(0));
  FEnums_5.AddObject('stssHidden',TObject(1));
  FEnums_5.AddObject('stssVeryHidden',TObject(2));
  FEnums_5.AddObject('stdaDVASPECT_CONTENT',TObject(0));
  FEnums_5.AddObject('stdaDVASPECT_ICON',TObject(1));
  FEnums_5.AddObject('stctNum',TObject(0));
  FEnums_5.AddObject('stctPercent',TObject(1));
  FEnums_5.AddObject('stctMax',TObject(2));
  FEnums_5.AddObject('stctMin',TObject(3));
  FEnums_5.AddObject('stctFormula',TObject(4));
  FEnums_5.AddObject('stctPercentile',TObject(5));
  FEnums_5.AddObject('stpoDownThenOver',TObject(0));
  FEnums_5.AddObject('stpoOverThenDown',TObject(1));
  FEnums_5.AddObject('stctB',TObject(0));
  FEnums_5.AddObject('stctN',TObject(1));
  FEnums_5.AddObject('stctD',TObject(2));
  FEnums_5.AddObject('stctE',TObject(3));
  FEnums_5.AddObject('stctS',TObject(4));
  FEnums_5.AddObject('stctStr',TObject(5));
  FEnums_5.AddObject('stctInlineStr',TObject(6));
  FEnums_5.AddObject('stpsSplit',TObject(0));
  FEnums_5.AddObject('stpsFrozen',TObject(1));
  FEnums_5.AddObject('stpsFrozenSplit',TObject(2));
  FEnums_5.AddObject('stcftNormal',TObject(0));
  FEnums_5.AddObject('stcftArray',TObject(1));
  FEnums_5.AddObject('stcftDataTable',TObject(2));
  FEnums_5.AddObject('stcftShared',TObject(3));
  FEnums_5.AddObject('stccNone',TObject(0));
  FEnums_5.AddObject('stccAsDisplayed',TObject(1));
  FEnums_5.AddObject('stccAtEnd',TObject(2));
  FEnums_5.AddObject('stdvoBetween',TObject(0));
  FEnums_5.AddObject('stdvoNotBetween',TObject(1));
  FEnums_5.AddObject('stdvoEqual',TObject(2));
  FEnums_5.AddObject('stdvoNotEqual',TObject(3));
  FEnums_5.AddObject('stdvoLessThan',TObject(4));
  FEnums_5.AddObject('stdvoLessThanOrEqual',TObject(5));
  FEnums_5.AddObject('stdvoGreaterThan',TObject(6));
  FEnums_5.AddObject('stdvoGreaterThanOrEqual',TObject(7));
  FEnums_5.AddObject('stctExpression',TObject(0));
  FEnums_5.AddObject('stctCellIs',TObject(1));
  FEnums_5.AddObject('stctColorScale',TObject(2));
  FEnums_5.AddObject('stctDataBar',TObject(3));
  FEnums_5.AddObject('stctIconSet',TObject(4));
  FEnums_5.AddObject('stctTop10',TObject(5));
  FEnums_5.AddObject('stctUniqueValues',TObject(6));
  FEnums_5.AddObject('stctDuplicateValues',TObject(7));
  FEnums_5.AddObject('stctContainsText',TObject(8));
  FEnums_5.AddObject('stctNotContainsText',TObject(9));
  FEnums_5.AddObject('stctBeginsWith',TObject(10));
  FEnums_5.AddObject('stctEndsWith',TObject(11));
  FEnums_5.AddObject('stctContainsBlanks',TObject(12));
  FEnums_5.AddObject('stctNotContainsBlanks',TObject(13));
  FEnums_5.AddObject('stctContainsErrors',TObject(14));
  FEnums_5.AddObject('stctNotContainsErrors',TObject(15));
  FEnums_5.AddObject('stctTimePeriod',TObject(16));
  FEnums_5.AddObject('stctAboveAverage',TObject(17));
  FEnums_5.AddObject('stpeDisplayed',TObject(0));
  FEnums_5.AddObject('stpeBlank',TObject(1));
  FEnums_5.AddObject('stpeDash',TObject(2));
  FEnums_5.AddObject('stpeNA',TObject(3));
  FEnums_5.AddObject('stouOLEUPDATE_ALWAYS',TObject(0));
  FEnums_5.AddObject('stouOLEUPDATE_ONCALL',TObject(1));
  FEnums_5.AddObject('stwstSheet',TObject(0));
  FEnums_5.AddObject('stwstPrintArea',TObject(1));
  FEnums_5.AddObject('stwstAutoFilter',TObject(2));
  FEnums_5.AddObject('stwstRange',TObject(3));
  FEnums_5.AddObject('stwstChart',TObject(4));
  FEnums_5.AddObject('stwstPivotTable',TObject(5));
  FEnums_5.AddObject('stwstQuery',TObject(6));
  FEnums_5.AddObject('stwstLabel',TObject(7));
  FEnums_5.AddObject('stdvesStop',TObject(0));
  FEnums_5.AddObject('stdvesWarning',TObject(1));
  FEnums_5.AddObject('stdvesInformation',TObject(2));
  FEnums_5.AddObject('sttpToday',TObject(0));
  FEnums_5.AddObject('sttpYesterday',TObject(1));
  FEnums_5.AddObject('sttpTomorrow',TObject(2));
  FEnums_5.AddObject('sttpLast7Days',TObject(3));
  FEnums_5.AddObject('sttpThisMonth',TObject(4));
  FEnums_5.AddObject('sttpLastMonth',TObject(5));
  FEnums_5.AddObject('sttpNextMonth',TObject(6));
  FEnums_5.AddObject('sttpThisWeek',TObject(7));
  FEnums_5.AddObject('sttpLastWeek',TObject(8));
  FEnums_5.AddObject('sttpNextWeek',TObject(9));
  FEnums_5.AddObject('stpBottomRight',TObject(0));
  FEnums_5.AddObject('stpTopRight',TObject(1));
  FEnums_5.AddObject('stpBottomLeft',TObject(2));
  FEnums_5.AddObject('stpTopLeft',TObject(3));
  FEnums_5.AddObject('stcfoLessThan',TObject(0));
  FEnums_5.AddObject('stcfoLessThanOrEqual',TObject(1));
  FEnums_5.AddObject('stcfoEqual',TObject(2));
  FEnums_5.AddObject('stcfoNotEqual',TObject(3));
  FEnums_5.AddObject('stcfoGreaterThanOrEqual',TObject(4));
  FEnums_5.AddObject('stcfoGreaterThan',TObject(5));
  FEnums_5.AddObject('stcfoBetween',TObject(6));
  FEnums_5.AddObject('stcfoNotBetween',TObject(7));
  FEnums_5.AddObject('stcfoContainsText',TObject(8));
  FEnums_5.AddObject('stcfoNotContains',TObject(9));
  FEnums_5.AddObject('stcfoBeginsWith',TObject(10));
  FEnums_5.AddObject('stcfoEndsWith',TObject(11));
  FEnums_5.AddObject('stdvimNoControl',TObject(0));
  FEnums_5.AddObject('stdvimOff',TObject(1));
  FEnums_5.AddObject('stdvimOn',TObject(2));
  FEnums_5.AddObject('stdvimDisabled',TObject(3));
  FEnums_5.AddObject('stdvimHiragana',TObject(4));
  FEnums_5.AddObject('stdvimFullKatakana',TObject(5));
  FEnums_5.AddObject('stdvimHalfKatakana',TObject(6));
  FEnums_5.AddObject('stdvimFullAlpha',TObject(7));
  FEnums_5.AddObject('stdvimHalfAlpha',TObject(8));
  FEnums_5.AddObject('stdvimFullHangul',TObject(9));
  FEnums_5.AddObject('stdvimHalfHangul',TObject(10));
  FEnums_5.AddObject('stsvtNormal',TObject(0));
  FEnums_5.AddObject('stsvtPageBreakPreview',TObject(1));
  FEnums_5.AddObject('stsvtPageLayout',TObject(2));
  FEnums_5.AddObject('stdcfAverage',TObject(0));
  FEnums_5.AddObject('stdcfCount',TObject(1));
  FEnums_5.AddObject('stdcfCountNums',TObject(2));
  FEnums_5.AddObject('stdcfMax',TObject(3));
  FEnums_5.AddObject('stdcfMin',TObject(4));
  FEnums_5.AddObject('stdcfProduct',TObject(5));
  FEnums_5.AddObject('stdcfStdDev',TObject(6));
  FEnums_5.AddObject('stdcfStdDevp',TObject(7));
  FEnums_5.AddObject('stdcfSum',TObject(8));
  FEnums_5.AddObject('stdcfVar',TObject(9));
  FEnums_5.AddObject('stdcfVarp',TObject(10));
  FEnums_5.AddObject('stdvtNone',TObject(0));
  FEnums_5.AddObject('stdvtWhole',TObject(1));
  FEnums_5.AddObject('stdvtDecimal',TObject(2));
  FEnums_5.AddObject('stdvtList',TObject(3));
  FEnums_5.AddObject('stdvtDate',TObject(4));
  FEnums_5.AddObject('stdvtTime',TObject(5));
  FEnums_5.AddObject('stdvtTextLength',TObject(6));
  FEnums_5.AddObject('stdvtCustom',TObject(7));
  FEnums_5.AddObject('stoDefault',TObject(0));
  FEnums_5.AddObject('stoPortrait',TObject(1));
  FEnums_5.AddObject('stoLandscape',TObject(2));

  FEnums_5.AddObject('stttworksheet',TObject(0));
  FEnums_5.AddObject('stttxml',TObject(1));
  FEnums_5.AddObject('stttqueryTable',TObject(2));

  FEnums_5.AddObject('sttrfnone',TObject(0));
  FEnums_5.AddObject('sttrfsum',TObject(1));
  FEnums_5.AddObject('sttrfmin',TObject(2));
  FEnums_5.AddObject('sttrfmax',TObject(3));
  FEnums_5.AddObject('sttrfaverage',TObject(4));
  FEnums_5.AddObject('sttrfcount',TObject(5));
  FEnums_5.AddObject('sttrfcountNums',TObject(6));
  FEnums_5.AddObject('sttrfstdDev',TObject(7));
  FEnums_5.AddObject('sttrfvar',TObject(8));
  FEnums_5.AddObject('sttrfcustom',TObject(9));

  FEnums_5.AddObject('stxdtstring',TObject(0));
  FEnums_5.AddObject('stxdtnormalizedString',TObject(1));
  FEnums_5.AddObject('stxdttoken',TObject(2));
  FEnums_5.AddObject('stxdtbyte',TObject(3));
  FEnums_5.AddObject('stxdtunsignedByte',TObject(4));
  FEnums_5.AddObject('stxdtbase64Binary',TObject(5));
  FEnums_5.AddObject('stxdthexBinary',TObject(6));
  FEnums_5.AddObject('stxdtinteger',TObject(7));
  FEnums_5.AddObject('stxdtpositiveInteger',TObject(8));
  FEnums_5.AddObject('stxdtnegativeInteger',TObject(9));
  FEnums_5.AddObject('stxdtnonPositiveInteger',TObject(10));
  FEnums_5.AddObject('stxdtnonNegativeInteger',TObject(11));
  FEnums_5.AddObject('stxdtint',TObject(12));
  FEnums_5.AddObject('stxdtunsignedInt',TObject(13));
  FEnums_5.AddObject('stxdtlong',TObject(14));
  FEnums_5.AddObject('stxdtunsignedLong',TObject(15));
  FEnums_5.AddObject('stxdtshort',TObject(16));
  FEnums_5.AddObject('stxdtunsignedShort',TObject(17));
  FEnums_5.AddObject('stxdtdecimal',TObject(18));
  FEnums_5.AddObject('stxdtfloat',TObject(19));
  FEnums_5.AddObject('stxdtdouble',TObject(20));
  FEnums_5.AddObject('stxdtboolean',TObject(21));
  FEnums_5.AddObject('stxdttime',TObject(22));
  FEnums_5.AddObject('stxdtdateTime',TObject(23));
  FEnums_5.AddObject('stxdtduration',TObject(24));
  FEnums_5.AddObject('stxdtdate',TObject(25));
  FEnums_5.AddObject('stxdtgMonth',TObject(26));
  FEnums_5.AddObject('stxdtgYear',TObject(27));
  FEnums_5.AddObject('stxdtgYearMonth',TObject(28));
  FEnums_5.AddObject('stxdtgDay',TObject(29));
  FEnums_5.AddObject('stxdtgMonthDay',TObject(30));
  FEnums_5.AddObject('stxdtName',TObject(31));
  FEnums_5.AddObject('stxdtQName',TObject(32));
  FEnums_5.AddObject('stxdtNCName',TObject(33));
  FEnums_5.AddObject('stxdtanyURI',TObject(34));
  FEnums_5.AddObject('stxdtlanguage',TObject(35));
  FEnums_5.AddObject('stxdtID',TObject(36));
  FEnums_5.AddObject('stxdtIDREF',TObject(37));
  FEnums_5.AddObject('stxdtIDREFS',TObject(38));
  FEnums_5.AddObject('stxdtENTITY',TObject(39));
  FEnums_5.AddObject('stxdtENTITIES',TObject(40));
  FEnums_5.AddObject('stxdtNOTATION',TObject(41));
  FEnums_5.AddObject('stxdtNMTOKEN',TObject(42));
  FEnums_5.AddObject('stxdtNMTOKENS',TObject(43));
  FEnums_5.AddObject('stxdtanyType',TObject(44));
end;
...
var
  i: integer;
begin
  i := FEnums_5.IndexOf(AValue);
  if i >= 0 then
    Result := Integer(FEnums_5.Objects[i])
  else
    Result := 0;
end;
...
begin
  if FRPr.Assigned then
    if xaElements in FRPr.Assigneds then
    begin
...
begin
  if FColor.Assigned and (FColor.Rgb <> 0) then
  begin
    FColor.WriteAttributes(AWriter);
    AWriter.SimpleTag('color');
  end;
...
begin
  ...
  begin
    ...
    if xaElements in FReferences.Assigneds then
    begin
  ...
  if FExtLst.Assigned then
    if xaElements in FExtLst.Assigneds then
    begin
      AWriter.BeginTag('extLst');
      FExtLst.Write(AWriter);
      AWriter.EndTag;
...
begin
  ...
  begin
    ...
    if xaElements in FFilters.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCustomFilters.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FPatternFill.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FGradientFill.Assigneds then
    begin
...
//    TCT_BorderPr(Result).FIsRead := True;
    Result.Assigneds := [xaRead];
  end;
end;
...
begin
  ...
  begin
    ...
    if xaElements in FLeft.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FRight.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FTop.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FBottom.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FDiagonal.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FVertical.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FHorizontal.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FPivotArea.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FSortState.Assigneds then
    begin
...
begin
  ...
  if FIs.Assigned then 
    if xaElements in FIs.Assigneds then
    begin
      AWriter.BeginTag('is');
      FIs.Write(AWriter);
      AWriter.EndTag;
...
begin
  if FFont.Assigned then 
    if xaElements in FFont.Assigneds then
    begin
  ...
  if FFill.Assigned then 
    if xaElements in FFill.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FBorder.Assigneds then
    begin
...
begin
  ...
  // Must be written. If not, Excel craches on print.
...
begin
  if FText.Assigned then 
    if xaElements in FText.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FRowBreaks.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FColBreaks.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FAutoFilter.Assigneds then
    begin
  ...
  if System.Assigned(FOnWriteC) then
    ...
    begin
      ...
      begin
        ...
        if xaElements in FC.Assigneds then
        begin
          AWriter.BeginTag('c');
          FC.Write(AWriter);
          AWriter.EndTag;
...
procedure TCT_Row.AfterTag(AReader: TXPGReader);
begin
  if (FC.Assigneds <> []) and System.Assigned(FOnReadC) then begin
//    AReader._Stop := True;

//    if FTableMode and (FR <> FCurrR) then begin
//      FCurrR := FR;
//      AReader._Stop := True;
//    end;
...
begin
  ...
  if FColorScale.Assigned then 
    if xaElements in FColorScale.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FDataBar.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FIconSet.Assigneds then
    begin
...
begin
  if FIndexedColors.Assigned then 
    if xaElements in FIndexedColors.Assigneds then
    begin
  ...
  if FMruColors.Assigned then 
    if xaElements in FMruColors.Assigneds then
    begin
...
procedure TCT_DefinedNames.AfterTag(AReader: TXPGReader);
begin
  if (FDefinedName.Assigneds <> []) and System.Assigned(FOnReadDefinedName) then
    FOnReadDefinedName(FDefinedName);
  FDefinedName.Assigneds := [];
end;
  ...
  if System.Assigned(FOnWriteComment) then 
    ...
    begin
      ...
      begin
        ...
        if xaElements in FComment.Assigneds then
        begin
...
procedure TCT_CommentList.AfterTag(AReader: TXPGReader);
begin
  if (FComment.Assigneds <> []) and System.Assigned(FOnReadComment) then begin
...
procedure TCT_Cols.AfterTag(AReader: TXPGReader);
begin
  if (FCol.Assigneds <> []) and System.Assigned(FOwner.OnReadWorksheetColsCol) then
...
begin
  ...
  QName := AReader.QName;
  if QName = 'row' then
//  if AReader.QNameHashA = 344 then
  begin
    Result := FRow;
...
//        if xaElements in FRow.Assigneds then
//        begin
...
procedure TCT_SheetData.AfterTag(AReader: TXPGReader);
begin
  if (FRow.Assigneds <> []) and System.Assigned(FOnReadRow) then
    FOnReadRow(FRow);
...
begin
  ...
  begin
    ...
    if xaElements in FDataRefs.Assigneds then
    begin
...
procedure TCT_MergeCells.AfterTag(AReader: TXPGReader);
begin
  if (FMergeCell.Assigneds <> []) and System.Assigned(FOnReadMergeCell) then
    FOnReadMergeCell(FMergeCell);
  FMergeCell.Assigneds := [];
end;
...
procedure TCT_Hyperlinks.AfterTag(AReader: TXPGReader);
begin
  if (FHyperlink.Assigneds <> []) and System.Assigned(FOnReadHyperlink) then
    FOnReadHyperlink(FHyperlink);
  FHyperlink.Assigneds := [];
end;
...
begin
  ...
  begin
    ...
    if xaElements in FNumFmts.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FFonts.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FFills.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FBorders.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCellStyleXfs.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCellXfs.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCellStyles.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FDxfs.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FTableStyles.Assigneds then
    begin
  ...
  if FColors.Assigned then 
    if xaElements in FColors.Assigneds then
    begin
...
//        if xaElements in FSi.Assigneds then
//        begin
          AWriter.BeginTag('si');
          FSi.Write(AWriter);
          AWriter.EndTag;
...
//      end;
  ...
  if FExtLst.Assigned then
    if xaElements in FExtLst.Assigneds then begin
      AWriter.BeginTag('extLst');
      FExtLst.Write(AWriter);
      AWriter.EndTag;
    end
...
procedure TCT_Sst.AfterTag(AReader: TXPGReader);
begin
  if (FSi.Assigneds <> []) and System.Assigned(FOnReadSi) then
    FOnReadSi(FSi);
  FSi.Assigneds := [];
end;
...
begin
  ...
  if FBookViews.Assigned then 
    if xaElements in FBookViews.Assigneds then
    begin
  ...
  if FSheets.Assigned then 
    if xaElements in FSheets.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FFunctionGroups.Assigneds then
    begin
  ...
  if FExternalReferences.Assigned then 
    if xaElements in FExternalReferences.Assigneds then
    begin
  ...
  if System.Assigned(FOnWriteDefinedNames) then
    ...
    begin
      ...
      if FDefinedNames.Assigned then 
        if xaElements in FDefinedNames.Assigneds then
        begin
  ...
  if FCustomWorkbookViews.Assigned then 
    if xaElements in FCustomWorkbookViews.Assigneds then
    begin
  ...
  if FPivotCaches.Assigned then 
    if xaElements in FPivotCaches.Assigneds then
    begin
  ...
  if FSmartTagTypes.Assigned then 
    if xaElements in FSmartTagTypes.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FWebPublishObjects.Assigneds then
    begin
...
procedure TCT_Workbook.AfterTag(AReader: TXPGReader);
begin
  if (FDefinedNames.Assigneds <> []) and System.Assigned(FOnReadDefinedNames) then
    FOnReadDefinedNames(FDefinedNames);
  FDefinedNames.Assigneds := [];
end;
...
begin
  if FAuthors.Assigned then 
    if xaElements in FAuthors.Assigneds then
    begin
...
//    if xaElements in FCommentList.Assigneds then
//    begin
...
begin
  ...
  begin
    ...
    if xaElements in FSheetPr.Assigneds then
    begin
  ...
  if FSheetViews.Assigned then 
    if xaElements in FSheetViews.Assigneds then
    begin
  ...
  if FCustomSheetViews.Assigned then 
    if xaElements in FCustomSheetViews.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FWebPublishItems.Assigneds then
    begin
...
begin
  ...
  if FOleObjects.Assigned then 
    if xaElements in FOleObjects.Assigneds then
    begin
...
begin
  ...
  if FSheetData.Assigned then 
    if xaElements in FSheetData.Assigneds then
    begin
  ...
  if FProtectedRanges.Assigned then 
    if xaElements in FProtectedRanges.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FScenarios.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FDataConsolidate.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FMergeCells.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FDataValidations.Assigneds then
    begin
  ...
  if FHyperlinks.Assigned then 
    if xaElements in FHyperlinks.Assigneds then
    begin
  ...
  if FCustomProperties.Assigned then 
    if xaElements in FCustomProperties.Assigneds then
    begin
  ...
  if FCellWatches.Assigned then 
    if xaElements in FCellWatches.Assigneds then
    begin
  ...
  if FIgnoredErrors.Assigned then 
    if xaElements in FIgnoredErrors.Assigneds then
    begin
  ...
  if FSmartTags.Assigned then 
    if xaElements in FSmartTags.Assigneds then
    begin
...
//    if xaElements in FControls.Assigneds then
//    begin
...
//      AWriter.SimpleTag('controls');
  ...
  begin
    ...
    if xaElements in FTableParts.Assigneds then
    begin
...
begin
  ...
  AReader.SkipNamespace := AReader.Namespace = 'x';
//  AReader.SkipNamespace := False;

  case AReader.QNameHashA of
    $0000042A: begin
      Result := FStyleSheet;
//      AReader.SkipNamespace := true;
    end;
...
begin
  ...
  if (AClassToWrite.ClassName = FStyleSheet.ClassName) and FStyleSheet.Assigned then
    if xaElements in FStyleSheet.Assigneds then
    begin
  ...
  if (AClassToWrite.ClassName = FWorkbook.ClassName) and FWorkbook.Assigned then
    if xaElements in FWorkbook.Assigneds then
    begin
  ...
  if (AClassToWrite.ClassName = FComments.ClassName) and FComments.Assigned then
    if xaElements in FComments.Assigneds then
    begin
  ...
  if (AClassToWrite.ClassName = FTable.ClassName) and FTable.Assigned then begin
    ...
    if xaElements in FTable.Assigneds then
    begin
  ...
  if FChartsheet.Assigned then
    if xaElements in FChartsheet.Assigneds then
    begin
  ...
  if FDialogsheet.Assigned then
    if xaElements in FDialogsheet.Assigneds then
    begin
  ...
  if (AClassToWrite.ClassName = FWorksheet.ClassName) and FWorksheet.Assigned then
    if xaElements in FWorksheet.Assigneds then
    begin
...
procedure TXPGDocXLSX.LoadFromStream(AStream: TStream; ARestore: boolean = False);
begin
  FReader.LoadFromStream(AStream,ARestore);
end;
...
begin
  ...
  begin
    ...
    if xaElements in FXmlColumnPr.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FTableColumns.Assigneds then
    begin
...
{$else}
  FEnums_5 := THashedStringList.Create;
{$endif}
  TXPGBase.AddEnums;
