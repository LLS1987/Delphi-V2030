...
{$ifdef DELPHI_5}
var FEnums_6: TStringList;
{$else}
var FEnums_6: THashedStringList;
{$endif}
...
begin
  FEnums_6.AddObject('stdvtNil',TObject(0));
  FEnums_6.AddObject('stdvtB',TObject(1));
  FEnums_6.AddObject('stdvtN',TObject(2));
  FEnums_6.AddObject('stdvtE',TObject(3));
  FEnums_6.AddObject('stdvtStr',TObject(4));
  FEnums_6.AddObject('stectB',TObject(0));
  FEnums_6.AddObject('stectN',TObject(1));
  FEnums_6.AddObject('stectE',TObject(2));
  FEnums_6.AddObject('stectS',TObject(3));
  FEnums_6.AddObject('stectStr',TObject(4));
  FEnums_6.AddObject('stectInlineStr',TObject(5));
end;
...
var
  i: integer;
begin
  i := FEnums_6.IndexOf(AValue);
  if i >= 0 then 
    Result := Integer(FEnums_6.Objects[i])
  else 
    Result := 0;
end;
...
{$else}
  FEnums_6 := THashedStringList.Create;
{$endif}
  TXPGBase.AddEnums;
