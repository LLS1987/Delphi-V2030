...
type PXLSBIFFToken = ^TXLSBIFFToken;
     TXLSBIFFToken = record
     Token: AxUCString;
...
private
     ...
     function  GetItems(Index: integer): PXLSBIFFToken;
...
public
     ...
     property Items[Index: integer]: PXLSBIFFToken read GetItems; default;
     // For debug
...
function TXLSTokenizer.GetItems(Index: integer): PXLSBIFFToken;
begin
  Result := PXLSBIFFToken(inherited Items[Index])
end;
