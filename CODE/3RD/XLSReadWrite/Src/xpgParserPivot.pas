...
type TST_Axis_N2 =  (staAxisRow_n2,staAxisCol_n2,staAxisPage_n2,staAxisValues_n2);
const StrTST_Axis_1: array[0..3] of AxUCString = ('axisRow','axisCol','axisPage','axisValues');
type TST_PivotAreaType_N2 =  (stpatNone_n2,stpatNormal_n2,stpatData_n2,stpatAll_n2,stpatOrigin_n2,stpatButton_n2,stpatTopRight_n2);
const StrTST_PivotAreaType_1: array[0..6] of AxUCString = ('none','normal','data','all','origin','button','topRight');
...
public
     ...
     property Type_: TST_PivotAreaType_N2 read FType write FType;
     ...
     property Axis: TST_Axis_N2 read FAxis write FAxis;
...
{$ifdef DELPHI_5}
var L_Enums_1: TStringList;
{$else}
var L_Enums_1: THashedStringList;
{$endif}

procedure AddEnums_2;
begin
  L_Enums_1.AddObject('staAxisRow',TObject(0));
  L_Enums_1.AddObject('staAxisCol',TObject(1));
  L_Enums_1.AddObject('staAxisPage',TObject(2));
  L_Enums_1.AddObject('staAxisValues',TObject(3));
  L_Enums_1.AddObject('stpatNone',TObject(0));
  L_Enums_1.AddObject('stpatNormal',TObject(1));
  L_Enums_1.AddObject('stpatData',TObject(2));
  L_Enums_1.AddObject('stpatAll',TObject(3));
  L_Enums_1.AddObject('stpatOrigin',TObject(4));
  L_Enums_1.AddObject('stpatButton',TObject(5));
  L_Enums_1.AddObject('stpatTopRight',TObject(6));
  L_Enums_1.AddObject('sttNone',TObject(0));
  L_Enums_1.AddObject('sttAll',TObject(1));
  L_Enums_1.AddObject('sttRow',TObject(2));
  L_Enums_1.AddObject('sttColumn',TObject(3));
  L_Enums_1.AddObject('stfstManual',TObject(0));
  L_Enums_1.AddObject('stfstAscending',TObject(1));
  L_Enums_1.AddObject('stfstDescending',TObject(2));
  L_Enums_1.AddObject('stgbRange',TObject(0));
  L_Enums_1.AddObject('stgbSeconds',TObject(1));
  L_Enums_1.AddObject('stgbMinutes',TObject(2));
  L_Enums_1.AddObject('stgbHours',TObject(3));
  L_Enums_1.AddObject('stgbDays',TObject(4));
  L_Enums_1.AddObject('stgbMonths',TObject(5));
  L_Enums_1.AddObject('stgbQuarters',TObject(6));
  L_Enums_1.AddObject('stgbYears',TObject(7));
  L_Enums_1.AddObject('ststNone',TObject(0));
  L_Enums_1.AddObject('ststAscending',TObject(1));
  L_Enums_1.AddObject('ststDescending',TObject(2));
  L_Enums_1.AddObject('ststAscendingAlpha',TObject(3));
  L_Enums_1.AddObject('ststDescendingAlpha',TObject(4));
  L_Enums_1.AddObject('ststAscendingNatural',TObject(5));
  L_Enums_1.AddObject('ststDescendingNatural',TObject(6));
  L_Enums_1.AddObject('stsdaNormal',TObject(0));
  L_Enums_1.AddObject('stsdaDifference',TObject(1));
  L_Enums_1.AddObject('stsdaPercent',TObject(2));
  L_Enums_1.AddObject('stsdaPercentDiff',TObject(3));
  L_Enums_1.AddObject('stsdaRunTotal',TObject(4));
  L_Enums_1.AddObject('stsdaPercentOfRow',TObject(5));
  L_Enums_1.AddObject('stsdaPercentOfCol',TObject(6));
  L_Enums_1.AddObject('stsdaPercentOfTotal',TObject(7));
  L_Enums_1.AddObject('stsdaIndex',TObject(8));
  L_Enums_1.AddObject('stitData',TObject(0));
  L_Enums_1.AddObject('stitDefault',TObject(1));
  L_Enums_1.AddObject('stitSum',TObject(2));
  L_Enums_1.AddObject('stitCountA',TObject(3));
  L_Enums_1.AddObject('stitAvg',TObject(4));
  L_Enums_1.AddObject('stitMax',TObject(5));
  L_Enums_1.AddObject('stitMin',TObject(6));
  L_Enums_1.AddObject('stitProduct',TObject(7));
  L_Enums_1.AddObject('stitCount',TObject(8));
  L_Enums_1.AddObject('stitStdDev',TObject(9));
  L_Enums_1.AddObject('stitStdDevP',TObject(10));
  L_Enums_1.AddObject('stitVar',TObject(11));
  L_Enums_1.AddObject('stitVarP',TObject(12));
  L_Enums_1.AddObject('stitGrand',TObject(13));
  L_Enums_1.AddObject('stitBlank',TObject(14));
  L_Enums_1.AddObject('stsSelection',TObject(0));
  L_Enums_1.AddObject('stsData',TObject(1));
  L_Enums_1.AddObject('stsField',TObject(2));
  L_Enums_1.AddObject('stpftUnknown',TObject(0));
  L_Enums_1.AddObject('stpftCount',TObject(1));
  L_Enums_1.AddObject('stpftPercent',TObject(2));
  L_Enums_1.AddObject('stpftSum',TObject(3));
  L_Enums_1.AddObject('stpftCaptionEqual',TObject(4));
  L_Enums_1.AddObject('stpftCaptionNotEqual',TObject(5));
  L_Enums_1.AddObject('stpftCaptionBeginsWith',TObject(6));
  L_Enums_1.AddObject('stpftCaptionNotBeginsWith',TObject(7));
  L_Enums_1.AddObject('stpftCaptionEndsWith',TObject(8));
  L_Enums_1.AddObject('stpftCaptionNotEndsWith',TObject(9));
  L_Enums_1.AddObject('stpftCaptionContains',TObject(10));
  L_Enums_1.AddObject('stpftCaptionNotContains',TObject(11));
  L_Enums_1.AddObject('stpftCaptionGreaterThan',TObject(12));
  L_Enums_1.AddObject('stpftCaptionGreaterThanOrEqual',TObject(13));
  L_Enums_1.AddObject('stpftCaptionLessThan',TObject(14));
  L_Enums_1.AddObject('stpftCaptionLessThanOrEqual',TObject(15));
  L_Enums_1.AddObject('stpftCaptionBetween',TObject(16));
  L_Enums_1.AddObject('stpftCaptionNotBetween',TObject(17));
  L_Enums_1.AddObject('stpftValueEqual',TObject(18));
  L_Enums_1.AddObject('stpftValueNotEqual',TObject(19));
  L_Enums_1.AddObject('stpftValueGreaterThan',TObject(20));
  L_Enums_1.AddObject('stpftValueGreaterThanOrEqual',TObject(21));
  L_Enums_1.AddObject('stpftValueLessThan',TObject(22));
  L_Enums_1.AddObject('stpftValueLessThanOrEqual',TObject(23));
  L_Enums_1.AddObject('stpftValueBetween',TObject(24));
  L_Enums_1.AddObject('stpftValueNotBetween',TObject(25));
  L_Enums_1.AddObject('stpftDateEqual',TObject(26));
  L_Enums_1.AddObject('stpftDateNotEqual',TObject(27));
  L_Enums_1.AddObject('stpftDateOlderThan',TObject(28));
  L_Enums_1.AddObject('stpftDateOlderThanOrEqual',TObject(29));
  L_Enums_1.AddObject('stpftDateNewerThan',TObject(30));
  L_Enums_1.AddObject('stpftDateNewerThanOrEqual',TObject(31));
  L_Enums_1.AddObject('stpftDateBetween',TObject(32));
  L_Enums_1.AddObject('stpftDateNotBetween',TObject(33));
  L_Enums_1.AddObject('stpftTomorrow',TObject(34));
  L_Enums_1.AddObject('stpftToday',TObject(35));
  L_Enums_1.AddObject('stpftYesterday',TObject(36));
  L_Enums_1.AddObject('stpftNextWeek',TObject(37));
  L_Enums_1.AddObject('stpftThisWeek',TObject(38));
  L_Enums_1.AddObject('stpftLastWeek',TObject(39));
  L_Enums_1.AddObject('stpftNextMonth',TObject(40));
  L_Enums_1.AddObject('stpftThisMonth',TObject(41));
  L_Enums_1.AddObject('stpftLastMonth',TObject(42));
  L_Enums_1.AddObject('stpftNextQuarter',TObject(43));
  L_Enums_1.AddObject('stpftThisQuarter',TObject(44));
  L_Enums_1.AddObject('stpftLastQuarter',TObject(45));
  L_Enums_1.AddObject('stpftNextYear',TObject(46));
  L_Enums_1.AddObject('stpftThisYear',TObject(47));
  L_Enums_1.AddObject('stpftLastYear',TObject(48));
  L_Enums_1.AddObject('stpftYearToDate',TObject(49));
  L_Enums_1.AddObject('stpftQ1',TObject(50));
  L_Enums_1.AddObject('stpftQ2',TObject(51));
  L_Enums_1.AddObject('stpftQ3',TObject(52));
  L_Enums_1.AddObject('stpftQ4',TObject(53));
  L_Enums_1.AddObject('stpftM1',TObject(54));
  L_Enums_1.AddObject('stpftM2',TObject(55));
  L_Enums_1.AddObject('stpftM3',TObject(56));
  L_Enums_1.AddObject('stpftM4',TObject(57));
  L_Enums_1.AddObject('stpftM5',TObject(58));
  L_Enums_1.AddObject('stpftM6',TObject(59));
  L_Enums_1.AddObject('stpftM7',TObject(60));
  L_Enums_1.AddObject('stpftM8',TObject(61));
  L_Enums_1.AddObject('stpftM9',TObject(62));
  L_Enums_1.AddObject('stpftM10',TObject(63));
  L_Enums_1.AddObject('stpftM11',TObject(64));
  L_Enums_1.AddObject('stpftM12',TObject(65));
  L_Enums_1.AddObject('ststWorksheet',TObject(0));
  L_Enums_1.AddObject('ststExternal',TObject(1));
  L_Enums_1.AddObject('ststConsolidation',TObject(2));
  L_Enums_1.AddObject('ststScenario',TObject(3));
  L_Enums_1.AddObject('stfaBlank',TObject(0));
  L_Enums_1.AddObject('stfaFormatting',TObject(1));
  L_Enums_1.AddObject('stfaDrill',TObject(2));
  L_Enums_1.AddObject('stfaFormula',TObject(3));
end;
...
var
  i: integer;
begin
  i := L_Enums_1.IndexOf(AValue);
  if i >= 0 then
    Result := Integer(L_Enums_1.Objects[i])
  else
    Result := 0;
end;
...
begin
  ...
  if FXmlns <> '' then
    AWriter.AddAttribute(FXmlns,FXmlnsValue);
end;
...
begin
  for i := 0 to AAttributes.Count - 1 do begin
    if AAttributes[i] = 'uri' then
      ...
      FXmlnsValue := AAttributes.Values[i];
    end;
  end;
end;
...
begin
  ...
  begin
    ...
    if xaElements in FGroupMembers.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FTpls.Assigneds then
    begin
...
begin
  ...
  if FType <> stpatNormal_n2 then
    AWriter.AddAttribute('type',StrTST_PivotAreaType_1[Integer(FType)]);
  if FDataOnly <> True then 
  ...
  if Integer(FAxis) <> XPG_UNKNOWN_ENUM then 
    AWriter.AddAttribute('axis',StrTST_Axis_1[Integer(FAxis)]);
  if FFieldPosition <> 2147483632 then 
...
begin
  for i := 0 to AAttributes.Count - 1 do 
    case AAttributes.HashA[i] of
      ...
      $000001C2: FType := TST_PivotAreaType_N2(StrToEnum('stpat' + AAttributes.Values[i]));
      ...
      $000001B5: FAxis := TST_Axis_N2(StrToEnum('sta' + AAttributes.Values[i]));
...
begin
  ...
  FAttributeCount := 12;
  FField := 2147483632;
  FType := TST_PivotAreaType_N2(XPG_UNKNOWN_ENUM);
  FType := stpatNormal_n2;
  FDataOnly := True;
  FLabelOnly := False;
  FGrandRow := False;
  FGrandCol := False;
  ...
  FAxis := TST_Axis_N2(XPG_UNKNOWN_ENUM);
...
begin
  ...
  begin
    ...
    if xaElements in FGroups.Assigneds then
    begin
...
//    AWriter.AddAttribute('containsString',XmlBoolToStr(FValues.StringCount > 0));
    AWriter.AddAttribute('containsSemiMixedTypes',XmlBoolToStr(False));
...
begin
  ...
  begin
    ...
    if xaElements in FDiscretePr.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FGroupItems.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FSortByTuple.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FItems.Assigneds then
    begin
  ...
  if (FAutoSortScope <> Nil) and FAutoSortScope.Assigned then 
    if xaElements in FAutoSortScope.Assigneds then
    begin
...
begin
  for i := 0 to AAttributes.Count - 1 do 
    case AAttributes.HashB[i] of
      ...
      $3DB9DC9B: FAxis := TST_Axis_N2(StrToEnum('sta' + AAttributes.Values[i]));
...
begin
  ...
  begin
    ...
    if xaElements in FPivotAreas.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FMps.Assigneds then
    begin
...
begin
  ...
  else if AReader.QName = 'autoFilter' then begin
    if FAutoFilter = Nil then
      FAutoFilter := TCT_AutoFilter.Create(FOwner);

    Result := TXPGBase(FAutoFilter);
  end
  else
    FOwner.Errors.Error(xemUnknownElement,AReader.QName);
  if Result <> Self then 
...
begin
  ...
  if (FAutoFilter <> Nil) and FAutoFilter.Assigned then begin
...
begin
  ...
  begin
    ...
    if xaElements in FPages.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FRangeSets.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FSharedItems.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FFieldGroup.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FFieldsUsage.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FGroupLevels.Assigneds then
    begin
...
begin
  ...
  FUnbalanced := Boolean(2);
  FUnbalancedGroup := Boolean(2);
  FHidden := False;
end;
...
begin
  ...
  FElementCount := 0;
  FAttributeCount := 6;
  FShowRowHeaders := Boolean(2);
  FShowColHeaders := Boolean(2);
  FShowRowStripes := Boolean(2);
  FShowColStripes := Boolean(2);
  FShowLastColumn := Boolean(2);
end;
...
begin
  ...
  begin
    ...
    if xaElements in FConsolidation.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FEntries.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FSets.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FQueryCache.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FServerFormats.Assigneds then
    begin
...
var
  Reader: TXPGReader;
begin
  FOwner.Errors := TXpgPErrors.Create;
  Reader := TXPGReader.Create(FOwner.Errors,Self);
  try
...
begin
  ...
  begin
    ...
    if xaElements in FPivotFields.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FRowFields.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FRowItems.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FColFields.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FColItems.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FPageFields.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FFormats.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FConditionalFormats.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FChartFormats.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FPivotHierarchies.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FRowHierarchiesUsage.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FColHierarchiesUsage.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FCacheSource.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCacheFields.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCacheHierarchies.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FKpis.Assigneds then
    begin
  ...
  if (FTupleCache_Dup <> Nil) and FTupleCache_Dup.Assigned then 
    if xaElements in FTupleCache_Dup.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCalculatedItems.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FCalculatedMembers.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FDimensions.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FMeasureGroups.Assigneds then
    begin
  ...
  begin
    ...
    if xaElements in FMaps.Assigneds then
    begin
...
begin
  ...
  if (FCurrWriteClass = Nil) or (FPivotCacheRecords.ClassName = FCurrWriteClass.ClassName) then
    ...
    begin
      ...
      if xaElements in FPivotCacheRecords.Assigneds then
      begin
  ...
  if (FCurrWriteClass = Nil) or (FPivotTableDefinition.ClassName = FCurrWriteClass.ClassName) then
    ...
    begin
      ...
      if xaElements in FPivotTableDefinition.Assigneds then
      begin
  ...
  if (FCurrWriteClass = Nil) or (FPivotCacheDefinition.ClassName = FCurrWriteClass.ClassName) then 
    ...
    begin
      ...
      if xaElements in FPivotCacheDefinition.Assigneds then
      begin
...
begin
  ...
  try
    ...
    if xaElements in Def.Assigneds then
    begin
...
begin
  ...
  try
    ...
    if xaElements in Def.Records.Assigneds then
    begin
...
{$else}
  L_Enums_1 := THashedStringList.Create;
{$endif}
  AddEnums_2;
