...
private
     ...
     procedure SetAsInteger(const AName: AxUCString; Value: integer);
protected
     FItems: TStringList;
...
begin
  ...
  if i >= 0 then
    ...
    raise XLSRWException.Create('Can not find enum ' + AValue);
end;
...
procedure TEG_ColorTransform.SetAsInteger(const AName: AxUCString; Value: integer);
var
  i: integer;
begin
  i := Find(AName);
...
begin
  if (FA_ScrgbClr <> Nil) and FA_ScrgbClr.Assigned then begin
    ...
    if xaElements in FA_ScrgbClr.Assigneds then begin
  ...
  if (FA_SrgbClr <> Nil) and FA_SrgbClr.Assigned then begin
    ...
    if xaElements in FA_SrgbClr.Assigneds then begin
  ...
  if (FA_HslClr <> Nil) and FA_HslClr.Assigned then begin
    ...
    if xaElements in FA_HslClr.Assigneds then begin
  ...
  if (FA_SysClr <> Nil) and FA_SysClr.Assigned then begin
    ...
    if xaElements in FA_SysClr.Assigneds then begin
  ...
  if (FA_SchemeClr <> Nil) and FA_SchemeClr.Assigned then begin
    ...
    if xaElements in FA_SchemeClr.Assigneds then begin
  ...
  if (FA_PrstClr <> Nil) and FA_PrstClr.Assigned then begin
    ...
    if xaElements in FA_PrstClr.Assigneds then begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Ext.Assigneds then 
    begin
...
begin
  if (FA_ClrFrom <> Nil) and FA_ClrFrom.Assigned then 
    if xaElements in FA_ClrFrom.Assigneds then 
    begin
  ...
  if (FA_ClrTo <> Nil) and FA_ClrTo.Assigned then 
    if xaElements in FA_ClrTo.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Path.Assigneds then 
    begin
...
begin
  for i := 0 to AAttributes.Count - 1 do begin
    case AAttributes.HashA[i] of
      $000002DD, // p6:embed  = Non standard Excel
...
begin
  ...
  if FA_Stretch <> Nil then begin
    if FA_Stretch.Assigned and (xaElements in FA_Stretch.Assigneds) then
    begin
...
begin
  if (FA_GsLst <> Nil) and FA_GsLst.Assigned then
    if xaElements in FA_GsLst.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Blip.Assigneds then 
    begin
...
begin
  if (FA_FgClr <> Nil) and FA_FgClr.Assigned then 
    if xaElements in FA_FgClr.Assigneds then 
    begin
  ...
  if (FA_BgClr <> Nil) and FA_BgClr.Assigned then 
    if xaElements in FA_BgClr.Assigneds then 
    begin
...
begin
  ...
  if (FA_SolidFill <> Nil) and FA_SolidFill.Assigned then 
    if xaElements in FA_SolidFill.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_GradFill.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_BlipFill.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_PattFill.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Cont.Assigneds then 
    begin
...
begin
  ...
  if (FA_CustDash <> Nil) and FA_CustDash.Assigned then 
    if xaElements in FA_CustDash.Assigneds then 
    begin
...
begin
  ...
  begin
    FA_FillOverlay.WriteAttributes(AWriter);
    if xaElements in FA_FillOverlay.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Glow.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_InnerShdw.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_OuterShdw.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_PrstShdw.Assigneds then 
    begin
...
begin
  if (FA_EffectLst <> Nil) and FA_EffectLst.Assigned then 
    if xaElements in FA_EffectLst.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_EffectDag.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_ULn.Assigneds then 
    begin
...
begin
  ...
  if (FA_UFill <> Nil) and FA_UFill.Assigned then 
    if xaElements in FA_UFill.Assigneds then 
    begin
...
begin
  ...
  if (FA_BuClr <> Nil) and FA_BuClr.Assigned then 
    if xaElements in FA_BuClr.Assigneds then 
    begin
...
begin
  ...
  if (FA_BuBlip <> Nil) and FA_BuBlip.Assigned then 
    if xaElements in FA_BuBlip.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Ln.Assigneds then 
    begin
  ...
  if (FA_Highlight <> Nil) and FA_Highlight.Assigned then 
    if xaElements in FA_Highlight.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_HlinkClick.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_HlinkMouseOver.Assigneds then 
    begin
...
begin
  if (FA_LnSpc <> Nil) and FA_LnSpc.Assigned then 
    if xaElements in FA_LnSpc.Assigneds then 
    begin
  ...
  if (FA_SpcBef <> Nil) and FA_SpcBef.Assigned then 
    if xaElements in FA_SpcBef.Assigneds then 
    begin
  ...
  if (FA_SpcAft <> Nil) and FA_SpcAft.Assigned then 
    if xaElements in FA_SpcAft.Assigneds then 
    begin
  ...
  if (FA_TabLst <> Nil) and FA_TabLst.Assigned then 
    if xaElements in FA_TabLst.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_DefRPr.Assigneds then 
    begin
...
begin
  ...
  FLatinLnBrk := Boolean(2);
  FHangingPunct := Boolean(2);
end;
...
begin
  ...
  if (FA_ExtrusionClr <> Nil) and FA_ExtrusionClr.Assigned then 
    if xaElements in FA_ExtrusionClr.Assigneds then 
    begin
  ...
  if (FA_ContourClr <> Nil) and FA_ContourClr.Assigned then 
    if xaElements in FA_ContourClr.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_RPr.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_PPr.Assigneds then 
    begin
...
begin
  if (FA_AvLst <> Nil) and FA_AvLst.Assigned then 
    if xaElements in FA_AvLst.Assigneds then 
    begin
  ...
  if (FA_GdLst <> Nil) and FA_GdLst.Assigned then 
    if xaElements in FA_GdLst.Assigneds then 
    begin
  ...
  if (FA_AhLst <> Nil) and FA_AhLst.Assigned then 
    if xaElements in FA_AhLst.Assigneds then 
    begin
  ...
  if (FA_CxnLst <> Nil) and FA_CxnLst.Assigned then 
    if xaElements in FA_CxnLst.Assigneds then 
    begin
  ...
  if (FA_PathLst <> Nil) and FA_PathLst.Assigned then 
    if xaElements in FA_PathLst.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Camera.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_LightRig.Assigneds then 
    begin
  ...
  if (FA_Backdrop <> Nil) and FA_Backdrop.Assigned then 
    if xaElements in FA_Backdrop.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Sp3d.Assigneds then 
    begin
...
begin
  if (FA_R <> Nil) and FA_R.Assigned then begin
    if xaElements in FA_R.Assigneds then begin
  ...
  if (FA_Br <> Nil) and FA_Br.Assigned then begin
    if xaElements in FA_Br.Assigneds then begin
  ...
  if (FA_Fld <> Nil) and FA_Fld.Assigned then begin
    ...
    if xaElements in FA_Fld.Assigneds then begin
...
begin
  if (FA_CustGeom <> Nil) and FA_CustGeom.Assigned then 
    if xaElements in FA_CustGeom.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_PrstGeom.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_PrstTxWarp.Assigneds then 
    begin
  ...
  if (FA_Scene3d <> Nil) and FA_Scene3d.Assigned then 
    if xaElements in FA_Scene3d.Assigneds then 
    begin
...
begin
  ...
  FSpcCol := 2147483632;
  FRtlCol := Boolean(2);
  FFromWordArt := Boolean(2);
  FAnchor := TST_TextAnchoringType(XPG_UNKNOWN_ENUM);
  FAnchorCtr := Boolean(2);
  FForceAA := Boolean(2);
  FUpright := False;
  FCompatLnSpc := Boolean(2);
end;
...
begin
  ...
  begin
    ...
    if xaElements in FA_DefPPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl1pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl2pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl3pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl4pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl5pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl6pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl7pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl8pPr.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_Lvl9pPr.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_EndParaRPr.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_Xfrm.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_LnRef.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_FillRef.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_EffectRef.Assigneds then 
    begin
  ...
  begin
    ...
    if xaElements in FA_FontRef.Assigneds then 
    begin
  ...
  for i := 0 to FA_PXpgList.Count - 1 do begin
    for j := 0 to FA_PXpgList[i].FA_EG_TextRuns.Count - 1 do begin
      if FA_PXpgList[i].FA_EG_TextRuns[j].Run.RPr.Sz < 100000 then
        Result := Max(Result,Double(FA_PXpgList[i].FA_EG_TextRuns[j].Run.RPr.Sz));
    end;
  end;
  Result := Result / 100;
end;
...
//  if (FA_LstStyle <> Nil) and FA_LstStyle.Assigned then
    if (FA_LstStyle <> Nil) and (xaElements in FA_LstStyle.Assigneds) then
    begin
...
begin
  if (FNvSpPr <> Nil) and FNvSpPr.Assigned then 
    if xaElements in FNvSpPr.Assigneds then 
    begin
  ...
  if (FTxBody <> Nil) and FTxBody.Assigned then 
    if xaElements in FTxBody.Assigneds then 
    begin
...
begin
  if (FA_Dk1 <> Nil) and FA_Dk1.Assigned then 
    if xaElements in FA_Dk1.Assigneds then 
    begin
  ...
  if (FA_Lt1 <> Nil) and FA_Lt1.Assigned then 
    if xaElements in FA_Lt1.Assigneds then 
    begin
  ...
  if (FA_Dk2 <> Nil) and FA_Dk2.Assigned then 
    if xaElements in FA_Dk2.Assigneds then 
    begin
  ...
  if (FA_Lt2 <> Nil) and FA_Lt2.Assigned then 
    if xaElements in FA_Lt2.Assigneds then 
    begin
  ...
  if (FA_Accent1 <> Nil) and FA_Accent1.Assigned then 
    if xaElements in FA_Accent1.Assigneds then 
    begin
  ...
  if (FA_Accent2 <> Nil) and FA_Accent2.Assigned then 
    if xaElements in FA_Accent2.Assigneds then 
    begin
  ...
  if (FA_Accent3 <> Nil) and FA_Accent3.Assigned then 
    if xaElements in FA_Accent3.Assigneds then 
    begin
  ...
  if (FA_Accent4 <> Nil) and FA_Accent4.Assigned then 
    if xaElements in FA_Accent4.Assigneds then 
    begin
  ...
  if (FA_Accent5 <> Nil) and FA_Accent5.Assigned then 
    if xaElements in FA_Accent5.Assigneds then 
    begin
  ...
  if (FA_Accent6 <> Nil) and FA_Accent6.Assigned then 
    if xaElements in FA_Accent6.Assigneds then 
    begin
  ...
  if (FA_Hlink <> Nil) and FA_Hlink.Assigned then 
    if xaElements in FA_Hlink.Assigneds then 
    begin
  ...
  if (FA_FolHlink <> Nil) and FA_FolHlink.Assigned then 
    if xaElements in FA_FolHlink.Assigneds then 
    begin
...
begin
  if (FA_MajorFont <> Nil) and FA_MajorFont.Assigned then 
    if xaElements in FA_MajorFont.Assigneds then 
    begin
  ...
  if (FA_MinorFont <> Nil) and FA_MinorFont.Assigned then 
    if xaElements in FA_MinorFont.Assigneds then 
    begin
...
begin
  if (FA_FillStyleLst <> Nil) and FA_FillStyleLst.Assigned then 
    if xaElements in FA_FillStyleLst.Assigneds then 
    begin
  ...
  if (FA_LnStyleLst <> Nil) and FA_LnStyleLst.Assigned then 
    if xaElements in FA_LnStyleLst.Assigneds then 
    begin
  ...
  if (FA_EffectStyleLst <> Nil) and FA_EffectStyleLst.Assigned then 
    if xaElements in FA_EffectStyleLst.Assigneds then 
    begin
  ...
  if (FA_BgFillStyleLst <> Nil) and FA_BgFillStyleLst.Assigned then 
    if xaElements in FA_BgFillStyleLst.Assigneds then 
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_HlinkHover.Assigneds then
    begin
...
begin
  ...
  begin
    ...
    if xaElements in FA_SpLocks.Assigneds then
    begin
...
begin
  ...
  if (FCNvSpPr <> Nil) and FCNvSpPr.Assigned then begin
    ...
    if xaElements in FCNvSpPr.Assigneds then begin
