...
begin
  if IsArea then
    // Braune - Add QuotedSheetName 01.03.2019
    Result := QuotedSheetname(SheetName) + '!' + AreaToRefStr(FCol1,FRow1,FCol2,FRow2,False,False,False,False)
  else
    // Braune - Add QuotedSheetName 01.03.2019
    Result := QuotedSheetname(SheetName) + '!' + ColRowToRefStr(FCol1,FRow1,False,False);
end;
...
begin
  if IsList then
    ...
    // Braune - Add QuotedSheetName 01.03.2019
    Result := QuotedSheetname(SheetName) + '!' + AreaToRefStr(FCol1,FRow1,FCol2,FRow2,True,True,True,True)
  else
    // Braune - Add QuotedSheetName 01.03.2019
    Result := QuotedSheetname(SheetName) + '!' + ColRowToRefStr(FCol1,FRow1,True,True);
end;
...
begin
  if IsArea then
    // Braune - Add QuotedSheetName 01.03.2019
    Result := QuotedSheetname(SheetName) + '!' + AreaToRefStr(FCol1,FRow1,FCol2,FRow1,True,True,True,True)
  else
    // Braune - Add QuotedSheetName 01.03.2019
    Result := QuotedSheetname(SheetName) + '!' + ColRowToRefStr(FCol1,FRow1,True,True);
end;
...
// Braune - Added 01.03.2019
function TXLSRelCells.QuotedSheetname(Value: string): string;
begin
  Result := QuotedStr(AnsiDequotedStr(Value, #39));
end;
