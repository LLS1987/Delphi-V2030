...
// (DO NOT EDIT: machine generated header) 'XLSRichPainter5.pas' rev: 35.00 (Windows)

#ifndef Xlsrichpainter5HPP
#define Xlsrichpainter5HPP
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall RichTextRect(Vcl::Graphics::TCanvas* ACanvas, const int AX1, const int AY1, const int AX2, const int AY2, Xc12datastylesheet5::PXc12FontRunArray AFontRuns, const int AFRCount, const System::UnicodeString AText)/* overload */;
extern DELPHI_PACKAGE void __fastcall RichTextRect(Vcl::Graphics::TCanvas* ACanvas, const double AX1, const double AY1, const double AX2, const double AY2, Xlstools5::TXLSFormattedText* AText, Xc12datastylesheet5::TXc12HorizAlignment AHorizAlign = (Xc12datastylesheet5::TXc12HorizAlignment)(0x1), Xc12datastylesheet5::TXc12VertAlignment AVertAlign = (Xc12datastylesheet5::TXc12VertAlignment)(0x0))/* overload */;
extern DELPHI_PACKAGE void __fastcall RichTextRect(Vcl::Graphics::TCanvas* ACanvas, const System::Types::TRect &ARect, Xc12datastylesheet5::TXc12XF* AXF, Xc12datastylesheet5::PXc12FontRunArray AFontRuns, const int AFRCount, const System::UnicodeString AText)/* overload */;
extern DELPHI_PACKAGE int __fastcall RichTextWidth(Vcl::Graphics::TCanvas* ACanvas, Xc12datastylesheet5::TXc12XF* AXF, Xc12datastylesheet5::PXc12FontRunArray AFontRuns, const int AFRCount, const System::UnicodeString AText);
}	/* namespace Xlsrichpainter5 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_XLSRICHPAINTER5)
using namespace Xlsrichpainter5;
#endif
#pragma pack(pop)
#pragma option pop
