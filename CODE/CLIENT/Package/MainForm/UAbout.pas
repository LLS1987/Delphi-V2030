...
begin
  var AParam:string := Format('AppVersion %s AppID %s AppName %s AppUpdateUrl %s',[FileVersion(Application.ExeName),'GanSuSPDA','甘肃药监接口','http://36.138.76.225:5005/winapp/gansu_spda/updater.json']);
...
begin
  ...
  lbl_IPAddress.Caption  := Format('本机：%s（%s）',[Goo.Login.LocalComputerName,Goo.Login.LocalIPAddress]);
